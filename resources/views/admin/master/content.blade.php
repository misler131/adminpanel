											...
											<div class="media flex-column flex-sm-row mt-0 mb-3">
					        					<div class="mr-sm-3 mb-2 mb-sm-0">
													<div class="card-img-actions">
														<a href="#">
															<img src="{{asset('/admin/global_assets/images/placeholders/placeholder.jpg')}}" class="img-fluid img-preview rounded" alt="">
										...
										<ul class="media-list">
											<li class="media">
												<div class="mr-3 position-relative">
													<img src="{{asset('/admin/global_assets/images/placeholders/placeholder.jpg')}}" class="rounded-circle" width="36" height="36" alt="">
